...
class DatabaseHelper(context: Context) : SQLiteOpenHelper(context, DATABASE_NAME, null, DATABASE_VERSION){
    ...
    private val SQL_CREATE_TABLE_TV_SHOW = String.format(
        "CREATE TABLE %s"
                ...
                " %s TEXT NOT NULL," +
                " %s TEXT NOT NULL)",
        DatabaseContract().TABLE_TV_MOVIE,
        DatabaseContract.TvMovieColumns.ID,
        DatabaseContract.TvMovieColumns.TITLE,
        DatabaseContract.TvMovieColumns.FIRST_AIR_DATE,
        DatabaseContract.TvMovieColumns.SCORE,
        DatabaseContract.TvMovieColumns.DESCRIPTION,
        DatabaseContract.TvMovieColumns.POSTER,
        DatabaseContract.TvMovieColumns.BACKDROP
    )
    ...
    override fun onUpgrade(db: SQLiteDatabase?, oldVersion: Int, newVersion: Int) {
        ...
        db?.execSQL("DROP TABLE IF EXISTS " + DatabaseContract().TABLE_TV_MOVIE)
